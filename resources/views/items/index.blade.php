...
@section('title', 'Master Item | Page')
                            ...
                            <tbody>
                                ...
                                @foreach ($items as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->name }}</td>
                                        <td>
                                            <a href="{{ route('items.show', $item->id) }}" class="btn btn-primary btn-sm"><i
                                                    class="fa fa-eye"></i></a>
                                            <button id='btnEdit' data-id="{{ $item->id }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#modal-default').on('hidden.bs.modal', function() {
                ...
                $('#itemId').val(''); // Reset the hidden input field
                $('#modal-title').text('Tambah Data'); // Reset modal title to default
            });

            $('#saveData').on('click', function() {
                var itemId = $('#itemId').val();
                var url = itemId ? "{{ url('items') }}/" + itemId : "{{ route('items.store') }}";
